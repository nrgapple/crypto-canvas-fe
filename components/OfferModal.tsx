                ...
                <ModalBody>
                    <FormControl>
                        ...
                        <InputGroup>
                            ...
                            <Input value={value} placeholder="0.00" onChange={(e) => setValue(e.target.value)} />
                        </InputGroup>
                        {value && <FormHelperText>WETH {web3Contract.web3.utils.toWei(value, 'ether')}</FormHelperText>}
